...
public class UpdateAppointment extends TestBase{
	
	public Response sendUpdateAppointmentRequest(int apptId, String name, String startTime,
			String endTime, String bookingSource, String createDateTime, String updateDateTime,
			String creator, String patientEMRId, String location, String emrPhysicianId, 
			String status, String notes, String reason, String type)
	{
		...
		appointmentDetails.put("emrAppointmentId", apptId);
		...
		//Response response = request.put("https://dev.api.blockhealth.co/emr/oscar/appointment");
		Response response = request.put("https://staging-api.phelix.ai/emr/oscar/appointment");
		return response;
	}
